...
lockstepClientReceiveTick LockstepClient
	...
	newIntentQueue <- do
		let reduce intents = case intents of
		...
		let newIntentQueue = reduce intentQueue ++ [LockstepTicked tick intent]
	...
	let nextState = lockstepTick config seed state

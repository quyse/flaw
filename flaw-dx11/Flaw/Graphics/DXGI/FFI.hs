{-|
Module: Flaw.Graphics.DXGI.FFI
Description: FFI for DXGI integration.
License: MIT
-}
...
-- | DXGI_SWAP_CHAIN_FLAG
genEnum [t|Word32|] "DXGI_SWAP_CHAIN_FLAG"
...
-- | DXGI_USAGE
type DXGI_USAGE = UINT
-- | DXGI_USAGE_* flags
genEnum [t|Word32|] "DXGI_USAGE_FLAG"
